# Generated by Django 2.0.1 on 2018-01-30 08:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_token', models.CharField(max_length=2550)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('track', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users', to='pages.Track')),
        ...
        migrations.AddField(
            model_name='genre',
            name='track',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='genrename', to='pages.Track'),
        ),
        migrations.AddField(
            model_name='chartdata',
            name='chart',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chartdata', to='pages.Charts'),
        ),
    ]
